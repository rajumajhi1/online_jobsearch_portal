  ...
  <tbody>
    <tr>
     ...
     <!--  <td><%=rs.getString(1)%></td>  -->
      ...
      <td><%=rs.getString(7)%></td><td><a href="ApplyJob.jsp?Jid=<%=Jid%>" style="text-decoration:none">APPLY</a></td>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
							...
							Designed By <a class="border-bottom" href="index.jsp">Job Search</a>
                        </div>
