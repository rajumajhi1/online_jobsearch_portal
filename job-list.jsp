...
session.setAttribute("str",SSID);
	        ...
	        PreparedStatement ps=con.prepareStatement("select * from Jobs  order by DoP desc");
                                ...
                                <div class="row g-4">
                                    <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                        ...
                                        <div class="text-start ps-4">
                                            <h5 class="mb-3" value=""><%=rs.getString(1)%></h5>
                                            <span class="text-truncate me-3"><i class="fa fa-map-marker-alt text-primary me-2"></i><%=rs.getString(2)%></span>
                                            <span class="text-truncate me-3"><i class="fa fa-map-marker-alt text-primary me-2"></i><%=rs.getString(3)%></span>
                                            <span class="text-truncate me-3"><i class="far fa-clock text-primary me-2"></i><%=rs.getString(4)%></span>
                                            <span class="text-truncate me-0"><i class="far fa-money-bill-alt text-primary me-2"></i><%=rs.getString(5)%></span>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                                            <a class="btn btn-light btn-square me-3" href=""><i class="far fa-heart text-primary"></i></a>
                                            <!--  <a class="btn btn-primary" href=""><%=rs.getString(7)%></a>-->
                                            <a class="btn btn-primary" href="ApplyJob.jsp?Jid=<%=Jid%>" style="text-decoration:none">APPLY</a>
                                        </div>
                                        <small class="text-truncate"><i class="far fa-calendar-alt text-primary me-2"></i><%=rs.getString(6)%></small>
                                    </div>
                                </div>
                            </div>
