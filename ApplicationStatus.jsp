...
<%
	String sid=session.getAttribute("SSID").toString();
...
String pass1="@budhadev2509";
	...
	PreparedStatement ps=con.prepareStatement("select * from Applications where UserForeign=?;");
    ...
    <div class="row">
       <div class="col">
		 ...
		 <h1>Application Status</h1><br><br>
		  ...
		  <p><b>Updated Status:</b><%=rs.getString(2)%><br>
		   <p><b>Interview Date:</b><%=rs.getString(3)%><br>
		   <p><b>Resume:</b><%=rs.getString(4)%><br>
		  <p><b>Apply Date:</b><%=rs.getString(5)%><br>
