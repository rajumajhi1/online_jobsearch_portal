...
<body>
    <div class="container-xxl bg-white p-0">
                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                 ...
                 <!--     <div class="nav-item dropdown">
                     ...
                     <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="login.html" class="dropdown-item">New Jobs</a>
                            <a href="CareerTips.html" class="dropdown-item">Career Tips</a>
        ...
        <div class="container-fluid p-0">
            <!-- <div class="owl-carousel header-carousel position-relative"> -->
                <div class="owl-carousel-item position-relative">
                    <img class="img-fluid" src="indexmainimg.jpg" alt="">
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                  ...
                                  <!--   <a href="SearchJob.html" class="btn btn-dark py-md-3 px-md-5 me-3 animated slideInLeft">Search A Job</a>  -->
        ...
        <!-- Search Start -->
       <form action="ShowByKeyCataLocIndex.jsp" method="post">
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <p class="mb-4">Every job post is authentic and will suit your profile because of our latest AI technology. It's our responsibility to find a best job for you.</p>
                        <p><i class="fa fa-check text-primary me-3"></i><b>Search job according to your SKILL</b></p>
                        <p><i class="fa fa-check text-primary me-3"></i><b>APPLY for job</b></p>
                        <p><i class="fa fa-check text-primary me-3"></i><b>GET the job</b></p>
