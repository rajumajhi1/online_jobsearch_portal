 ...
 <%
    ...
    String search=request.getParameter("search");
     ...
     String Loca=request.getParameter("Loca");
        ...
        PreparedStatement ps1=con.prepareStatement("select * from Jobs where Title=? and Catagory=? and Location=? and Status='Active' order by DoP desc");
