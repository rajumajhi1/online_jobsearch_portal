...
<head>
<meta charset="UTF-8">
<title>Show By Search Index</title>
 <!-- Google Web Fonts -->
 ...
 <%
    ...
    String search=request.getParameter("search");
     ...
     String Loca=request.getParameter("Loca");
        ...
        PreparedStatement ps1=con.prepareStatement("select * from Jobs where Title=? or Catagory=? or Location=? and Status='Active' order by DoP desc");
        ps1.setString(1, search);
        ps1.setString(2, Cata);
        ps1.setString(3, Loca);
