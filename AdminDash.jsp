...
<head>
<%
String adm=session.getAttribute("NaMe").toString();
%>
    <meta charset="utf-8">
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            <a href="" class="navbar-brand d-flex align-items-center text-center py-0 px-4 px-lg-5">
                ...
                String admn=session.getAttribute("usnm1").toString();
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="OwnJobPosts.jsp" class="dropdown-item">View Own Posts</a>
                            <a href="ViewApplications.jsp" class="dropdown-item">View Applications</a>
                        </div>
                    </div>
                  <!--    <div class="nav-item dropdown">
                ...
                <a href="AddJ.jsp" class="btn btn-dark rounded-0 py-4 px-lg-5 d-none d-lg-block">Post A Job<i class="fa fa-arrow-right ms-3"></i></a>
            </div>
        </nav>
        <!-- Navbar End -->
        ...
        <div class="container-fluid p-0">
            <!-- <div class="owl-carousel header-carousel position-relative"> -->
                <div class="owl-carousel-item position-relative">
                    <img class="img-fluid" src="admindash.jpg" alt="">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(43, 57, 64, .5);">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    <h1 class="display-3 text-white animated slideInDown mb-4">Find The Perfect Candidate </h1>
                                    <p class="fs-5 fw-medium text-white mb-4 pb-2"></p>
                                    <a href="FindActiveCandidates.jsp" class="btn btn-dark py-md-3 px-md-5 me-3 animated slideInLeft">Find Active Candidates</a>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        <h1 class="mb-4">We Help To Find A Talent That Will Help To Reach The Peak</h1>
                        <p class="mb-4">Every profile are verified and trusted. According to your requirement we will fetch you highly skilled and enormous candidates profile.</p>
                        <p><i class="fa fa-check text-primary me-3"></i><b>POST a job</b></p>
                        <p><i class="fa fa-check text-primary me-3"></i><b>GET applications</b></p>
                        <p><i class="fa fa-check text-primary me-3"></i><b>SELECT applications</b></p>
